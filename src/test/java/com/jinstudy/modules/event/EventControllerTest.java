...
import com.jinstudy.modules.study.*;
...
class EventControllerTest{
    ...
    void newEnrollment_FCFS_event_accepted() throws Exception {
        ...
        Event event = eventFactory.createEvent("test-event", EventType.FCFS, 2, study, sejin);
    ...
    void  newEnrollment_FCFS_event_not_accepted() throws Exception {
        ...
        Account haverz = accountFactory.createAccount("haverz");
        Account kante = accountFactory.createAccount("kante");
    ...
    void createEnroll_CONFIRMATIVE_event_no_accepted() throws Exception {
        Account sejin = accountFactory.createAccount("sejin");
        Study study = studyFactory.createStudy("test-study",sejin);
        Event event = eventFactory.createEvent("test-event",EventType.CONFIRMATIVE,2,study,sejin);
